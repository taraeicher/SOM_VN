#!/bin/bash
#SBATCH --job-name=permChromHMMHeartHigh
#SBATCH --nodes=1 --ntasks=1 --mem=1g --cpus-per-task=1
#SBATCH --time=00:30:00
#SBATCH --output=permChromHMMHeartHigh_%A_%a.out
#SBATCH --error=permChromHMMHeartHigh_%A_%a.err
#SBATCH --array=1-22
...
#Variables
	...
	CHROMHMM_PERM=$BASE_PATH/chromhmm/heart_E083_perm.bed
