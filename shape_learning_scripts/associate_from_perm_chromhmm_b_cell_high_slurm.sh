#!/bin/bash
#SBATCH --job-name=permChromHMMBCellHigh
#SBATCH --nodes=1 --ntasks=1 --mem=1g --cpus-per-task=1
#SBATCH --time=1:00:00
#SBATCH --output=permChromHMMBCellHigh_%A_%a.out
#SBATCH --error=permChromHMMBCellHigh_%A_%a.err
#SBATCH --array=1-22
...
#Variables
	...
	CHROMHMM_PERM=$BASE_PATH/chromhmm/b_cell_E032_perm.bed
