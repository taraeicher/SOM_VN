#!/bin/bash
#SBATCH --job-name=permChromHMMHeLaHigh
#SBATCH --nodes=1 --ntasks=1 --mem=1g --cpus-per-task=1
#SBATCH --time=00:30:00
#SBATCH --output=permChromHMMHeLaHigh_%A_%a.out
#SBATCH --error=permChromHMMHeLaHigh_%A_%a.err
#SBATCH --array=1-22
...
#Variables
	...
	CELL_LINE="HeLa_high"
	CHROMHMM_PERM=$BASE_PATH/chromhmm/hela_E117_perm.bed
