#!/bin/bash
#SBATCH --job-name=learnPermShapesHeartHigh
#SBATCH --nodes=1 --ntasks=1 --mem=3g
#SBATCH --partition=gpu
#SBATCH --gres=gpu:k20x:1
#SBATCH --time=1:00:00
#SBATCH --output=perm_shapesHeartHigh_%A_%a.out
#SBATCH --error=perm_shapesHeartHigh_%A_%a.err
#SBATCH --array=1-22
...
#Variables
    ...
    CELL_LINE="heart_high"
    REGION_SIZE=4000
    CHROMHMM=$BASE_PATH/chromhmm/heart_E083.bed 
    BIN_SIZE=50
