#!/bin/bash
#SBATCH --job-name=permChromHMMBrainLow
#SBATCH --nodes=1 --ntasks=1 --mem=1g --cpus-per-task=1
#SBATCH --time=00:30:00
#SBATCH --output=permChromHMMBrainLow_%A_%a.out
#SBATCH --error=permChromHMMBrainLow_%A_%a.err
#SBATCH --array=1-22
...
#Variables
	...
	CELL_LINE="Brain_low"
	CHROMHMM_PERM=$BASE_PATH/chromhmm/brain_E081_perm.bed
