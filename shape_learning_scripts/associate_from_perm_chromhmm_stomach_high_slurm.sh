#!/bin/bash
#SBATCH --job-name=permChromHMMStomachHigh
#SBATCH --nodes=1 --ntasks=1 --mem=1g --cpus-per-task=1
#SBATCH --time=00:30:00
#SBATCH --output=permChromHMMStomachHigh_%A_%a.out
#SBATCH --error=permChromHMMStomachHigh_%A_%a.err
#SBATCH --array=1-22
...
#Variables
	...
	CHROMHMM_PERM=$BASE_PATH/chromhmm/stomach_E092_perm.bed
