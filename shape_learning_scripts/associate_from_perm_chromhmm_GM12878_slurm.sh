#!/bin/bash
#SBATCH --job-name=permChromHMMGM12878
#SBATCH --nodes=1 --ntasks=1 --mem=1g --cpus-per-task=1
#SBATCH --time=00:30:00
#SBATCH --output=permChromHMMGM12878_%A_%a.out
#SBATCH --error=permChromHMMGM12878_%A_%a.err
#SBATCH --array=1-22
...
#Variables
	...
	CELL_LINE="GM12878"
	CHROMHMM_PERM=$BASE_PATH/chromhmm/GM12878_E116_perm.bed
