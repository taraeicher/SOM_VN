#!/bin/bash
#SBATCH --job-name=learnPermShapesBrainLow
#SBATCH --nodes=1 --ntasks=1 --mem=3g
#SBATCH --partition=gpu
#SBATCH --gres=gpu:k20x:1
#SBATCH --time=1:00:00
#SBATCH --output=shapesBrainLow_%A_%a.out
#SBATCH --error=shapesBrainLow_%A_%a.err
#SBATCH --array=1-22
...
#Variables
    ...
    CELL_LINE="Brain_low"
    REGION_SIZE=4000
    CHROMHMM=$BASE_PATH/chromhmm/brain_E081.bed
    BIN_SIZE=50
