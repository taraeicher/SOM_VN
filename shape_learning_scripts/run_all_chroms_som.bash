...
do
    qsub -A $PROJECT learn_shapes_for_chrom_vnssom.sh -d $BASE_PATH -h $CHROMHMM -t $CCCUTOFF -a -c $chrom -t $THRESHOLD -u -a $TRAINING -u $BASE_PATH/percentilecutoffs/$chrom.txt 
done
