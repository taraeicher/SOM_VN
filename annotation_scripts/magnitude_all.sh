...
CHROMHMMS=(brain_E081.bed b_cell_E032.bed A549_E114.bed b_cell_E032.bed brain_E081.bed H1_E003.bed hela_E117.bed hela_E117.bed heart_E083.bed heart_E083.bed stomach_E092.bed stomach_E092.bed GM12878_E116.bed)
for i in {0..10};
do
