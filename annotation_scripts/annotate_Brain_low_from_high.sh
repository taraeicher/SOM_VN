#!/bin/bash
#SBATCH --job-name=annotateBrainLowFromHigh
#SBATCH --nodes=1 --ntasks=1 --mem=3g
#SBATCH --time=2:00:00
#SBATCH --output=annotateBrainLowFromHigh_%A_%a.out
#SBATCH --error=annotateBrainLowFromHigh_%A_%a.err
#SBATCH --array=1-22
...
CELL_LINE_SRC="Brain_high"
CELL_LINE_TGT="Brain_low"
