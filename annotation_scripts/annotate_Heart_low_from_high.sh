#!/bin/bash
#SBATCH --job-name=annotateHeartLowFromHigh
#SBATCH --nodes=1 --ntasks=1 --mem=3g
#SBATCH --time=1:00:00
#SBATCH --output=annotateHeartLowFromHigh_%A_%a.out
#SBATCH --error=annotateHeartLowFromHigh_%A_%a.err
#SBATCH --array=1-22
...
CELL_LINE_SRC="heart_high"
CELL_LINE_TGT="heart_low"
