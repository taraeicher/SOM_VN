#!/bin/bash
#SBATCH --job-name=annotateBCellLowFromHigh
#SBATCH --nodes=1 --ntasks=1 --mem=3g
#SBATCH --time=1:00:00
#SBATCH --output=annotateBCellLowFromHigh_%A_%a.out
#SBATCH --error=annotateBCellLowFromHigh_%A_%a.err
#SBATCH --array=1-22
...
CELL_LINE_SRC="b_cell_high"
CELL_LINE_TGT="b_cell_low"
