#!/bin/bash
#SBATCH --job-name=annotateA549Rep2
#SBATCH --nodes=1 --ntasks=1 --mem=3g
#SBATCH --time=2:00:00
#SBATCH --output=annotateA549_rep2_%A_%a.out
#SBATCH --error=annotateA549_rep2_%A_%a.err
#SBATCH --array=1-22
...
CHROMHMM=$BASE_PATH/chromhmm/A549_E114.bed
