#!/bin/bash
#SBATCH --job-name=annotateHeLaLowFromHigh
#SBATCH --nodes=1 --ntasks=1 --mem=3g
#SBATCH --time=1:00:00
#SBATCH --output=annotateHeLaLowFromHigh_%A_%a.out
#SBATCH --error=annotateHeLaLowFromHigh_%A_%a.err
#SBATCH --array=1-22
...
CELL_LINE_SRC="HeLa_high"
CELL_LINE_TGT="HeLa_low"
