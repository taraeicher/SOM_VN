...
#Create all needed directories.
    ...
    for c in $CHROMS_NUM;
    do
        python split_regions.py ${WIG}/$c.wig $BIN_SIZE $c $SPLIT_DIR/${c}.pkl $REGION_SIZE 0.95 $SPLIT_DIR/shifted/${c}.pkl $SPLIT_DIR/crossings/${c}.txt $SPLIT_DIR/percentile_cutoffs/${c}.txt
